# Welome to the Systems over model interactive tutorial.

Here you can find the scripts used during the session to follow allong or tinker with.
...
The scripts are intended to be run in their respective folder as working directory.
